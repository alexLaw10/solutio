...
describe('Area Component', () => {
  it('should render loading state', () => {
    const { getByText } = render(<Area />, { wrapper });
  ...
  it('should render error state', () => {
    ...
    const { getByText } = render(<Area />, { wrapper });
    expect(getByText('Série Temporal de Temperatura')).toBeTruthy();
